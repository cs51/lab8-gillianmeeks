...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let id_ = new_id () in
    (evt := ({id = id_ ; action = listener} :: !evt));
    id_;;
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := (List.filter (fun p -> (p).id != i) !evt);;
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    List.iter (fun p -> p.action arg) !evt;;
...
called "newswire" that should pass strings to the event handlers.  event handlers are listeners which are functions
......................................................................*)
...
let fakeNewsid = WEvent.add_listener newswire fakeNewsNetwork;;
...
WEvent.remove_listener newswire fakeNewsid;;
WEvent.remove_listener newswire fakeNewsid;;
(* .. *)
...
let receive_report (s :string) : unit = let id =
  WEvent.add_listener publish (fun () -> print_string s) in ();;
